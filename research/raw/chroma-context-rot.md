...
![Image 1](https://research.trychroma.com/img/context_rot/niah_lexical.png)
...
`@techreport{hong2025context,  title = {Context Rot: How Increasing Input Tokens Impacts LLM Performance},  author = {Hong, Kelly and Troynikov, Anton and Huber, Jeff},  year = {2025},  month = {July},  institution = {Chroma},  url = {https://research.trychroma.com/context-rot},}`

Interested in working on improving retrieval for AI applications? [Chroma is Hiring](https://careers.trychroma.com/)

Introduction[#](https://research.trychroma.com/context-rot)
-----------------------------------------------------------
...
Contributions[#](https://research.trychroma.com/context-rot)
------------------------------------------------------------
...
Related Work[#](https://research.trychroma.com/context-rot)
-----------------------------------------------------------
...
Needle in a Haystack Extension[#](https://research.trychroma.com/context-rot)
-----------------------------------------------------------------------------
...
![Image 2](https://research.trychroma.com/img/context_rot/niah/lexical_2.png)
...
![Image 3](https://research.trychroma.com/img/context_rot/niah/distractor_irrelevance.png)
...
Needle-Question Similarity[#](https://research.trychroma.com/context-rot)
-------------------------------------------------------------------------
...
Needle-Haystack Similarity[#](https://research.trychroma.com/context-rot)
-------------------------------------------------------------------------
...
Haystack Structure[#](https://research.trychroma.com/context-rot)
-----------------------------------------------------------------
...
Details[#](https://research.trychroma.com/context-rot)
------------------------------------------------------
...
Experiment[#](https://research.trychroma.com/context-rot)
---------------------------------------------------------
...
Results[#](https://research.trychroma.com/context-rot)
------------------------------------------------------
...
![Image 4](https://research.trychroma.com/img/context_rot/longmemeval/needle_question_sim_arxiv.png)
...
![Image 5](https://research.trychroma.com/img/context_rot/niah/distractors_var.png)
...
![Image 6](https://research.trychroma.com/img/context_rot/niah/distractors_num.png)
...
![Image 7](https://research.trychroma.com/img/context_rot/niah/distractors_ind.png)
...
![Image 8](https://research.trychroma.com/img/context_rot/niah/hallucinations.png)
...
![Image 9](https://research.trychroma.com/img/context_rot/niah/needle_haystack.png)
...
![Image 10](https://research.trychroma.com/img/context_rot/niah/needle_haystack_2.png)
...
![Image 11](https://research.trychroma.com/img/context_rot/niah/nh2.png)
...
![Image 12](https://research.trychroma.com/img/context_rot/niah/structure_2.png)
...
LongMemEval[#](https://research.trychroma.com/context-rot)
----------------------------------------------------------
...
![Image 13](https://research.trychroma.com/img/context_rot/longmemeval/ex.png)
...
![Image 14](https://research.trychroma.com/img/context_rot/longmemeval/claude.png)
...
![Image 15](https://research.trychroma.com/img/context_rot/longmemeval/gpt.png)

LongMemEval Results - GPT Family

![Image 16](https://research.trychroma.com/img/context_rot/longmemeval/gemini.png)

LongMemEval Results - Gemini Family

![Image 17](https://research.trychroma.com/img/context_rot/longmemeval/qwen.png)
...
![Image 18](https://research.trychroma.com/img/context_rot/longmemeval/claude_comparison.png)
...
![Image 19](https://research.trychroma.com/img/context_rot/repeated_words/claude_line_plot.png)
...
![Image 20](https://research.trychroma.com/img/context_rot/repeated_words/claude_position_accuracy.png)
...
![Image 21](https://research.trychroma.com/img/context_rot/repeated_words/claude_num_words.png)
...
![Image 22](https://research.trychroma.com/img/context_rot/repeated_words/gpt_line_plot.png)
...
![Image 23](https://research.trychroma.com/img/context_rot/repeated_words/gpt_4_turbo.png)
...
![Image 24](https://research.trychroma.com/img/context_rot/repeated_words/gemini_line_plot.png)
...
![Image 25](https://research.trychroma.com/img/context_rot/repeated_words/qwen_line_plot.png)
...
Limitations & Future Work[#](https://research.trychroma.com/context-rot)
------------------------------------------------------------------------
...
Conclusion[#](https://research.trychroma.com/context-rot)
---------------------------------------------------------
...
Footnotes[#](https://research.trychroma.com/context-rot)
--------------------------------------------------------
...
References[#](https://research.trychroma.com/context-rot)
---------------------------------------------------------
...
Appendix[#](https://research.trychroma.com/context-rot)
-------------------------------------------------------
...
LLM judge alignment:[#](https://research.trychroma.com/context-rot)
-------------------------------------------------------------------
...
Models Tested[#](https://research.trychroma.com/context-rot)
------------------------------------------------------------

Not all 18 models are included in each experiement due to context window or thinking_budget constraints.

### Anthropic[#](https://research.trychroma.com/context-rot)
...
### OpenAI[#](https://research.trychroma.com/context-rot)
...
### Google[#](https://research.trychroma.com/context-rot)

*   Gemini 2.5 Pro
*   Gemini 2.5 Flash
*   Gemini 2.0 Flash

### Alibaba[#](https://research.trychroma.com/context-rot)

*   Qwen3-235B-A22B
*   Qwen3-32B
*   Qwen3-8B

Embedding Models Used[#](https://research.trychroma.com/context-rot)
--------------------------------------------------------------------
...
![Image 26](https://research.trychroma.com/img/context_rot/appendix/arxiv_pg_nq_sim.png)

Needle-Question Similarity - arXiv haystack/PG essay needles

![Image 27](https://research.trychroma.com/img/context_rot/appendix/pg_pg_nq_sim.png)

Needle-Question Similarity - PG essay haystack/PG essay needles

![Image 28](https://research.trychroma.com/img/context_rot/appendix/pg_arxiv_nq_sim.png)
...
![Image 29](https://research.trychroma.com/img/context_rot/appendix/distractors_num_arxiv.png)

Impact of Distractors: Performance by Number of Distractors - arXiv haystack/arXiv needles

![Image 30](https://research.trychroma.com/img/context_rot/appendix/distractors_ind_arxiv.png)

Impact of Distractors: Performance by Individual Distractors - arXiv haystack/arXiv needles

![Image 31](https://research.trychroma.com/img/context_rot/appendix/distractors_num_pg.png)

Impact of Distractors: Performance by Number of Distractors - PG essay haystack/PG essay needles

![Image 32](https://research.trychroma.com/img/context_rot/appendix/distractors_ind_pg.png)

Impact of Distractors: Performance by Individual Distractors - PG essay haystack/PG essay needles

![Image 33](https://research.trychroma.com/img/context_rot/appendix/distractors_num_pg_arxiv.png)

Impact of Distractors: Performance by Number of Distractors - PG essay haystack/arXiv needles

![Image 34](https://research.trychroma.com/img/context_rot/appendix/distractors_ind_pg_arxiv.png)

Impact of Distractors: Performance by Individual Distractors - PG essay haystack/arXiv needles

![Image 35](https://research.trychroma.com/img/context_rot/appendix/failures_arxiv.png)

Impact of Distractors: Failure Analysis - arXiv haystack/arXiv needles

![Image 36](https://research.trychroma.com/img/context_rot/appendix/failures_writing.png)

Impact of Distractors: Failure Analysis - PG essay haystack/PG essay needles

![Image 37](https://research.trychroma.com/img/context_rot/appendix/failures_writing_arxiv.png)
...
![Image 38](https://research.trychroma.com/img/context_rot/appendix/gpt_position_accuracy.png)

Repeated Words: Position Accuracy - GPT Family

![Image 39](https://research.trychroma.com/img/context_rot/appendix/gemini_position_accuracy.png)

Repeated Words: Position Accuracy - Gemini Family

![Image 40](https://research.trychroma.com/img/context_rot/appendix/qwen_position_accuracy.png)

Repeated Words: Position Accuracy - Qwen Family

![Image 41](https://research.trychroma.com/img/context_rot/appendix/wc_gpt.png)

Repeated Words: Word Count Difference - GPT Family

![Image 42](https://research.trychroma.com/img/context_rot/appendix/wc_gemini.png)

Repeated Words: Word Count Difference - Gemini Family

![Image 43](https://research.trychroma.com/img/context_rot/appendix/wc_qwen.png)
