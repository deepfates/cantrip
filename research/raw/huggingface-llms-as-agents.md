---
title: "HuggingFace Blog - Open Source LLMs as Agents"
...
URL Source: https://huggingface.co/blog/open-source-llms-as-agents

Markdown Content:
[Back to Articles](https://huggingface.co/blog)

[![Image 1: Aymeric Roucher's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/63d10d4e8eaa4831005e92b5/7p7-OmWM6PqqCs7ZStPGD.jpeg)](https://huggingface.co/m-ric)

[![Image 2: Joffrey THOMAS's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/64257c616d0f0f5f1dc6aa2a/WNXC2PcyDn-jt9ZY5Rbka.jpeg)](https://huggingface.co/Jofthomas)

[![Image 3: Andrew Reed's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/61d375fd733d3a83ecd1bba9/oIXwvvs1-HaCnJXMCZgkc.jpeg)](https://huggingface.co/andrewrreed)

*   [TL;DR](https://huggingface.co/blog/open-source-llms-as-agents#tldr "TL;DR")

*   [Introduction](https://huggingface.co/blog/open-source-llms-as-agents#introduction "Introduction")

*   [Table of Contents](https://huggingface.co/blog/open-source-llms-as-agents#table-of-contents "Table of Contents")

*   [What are agents?](https://huggingface.co/blog/open-source-llms-as-agents#what-are-agents "What are agents?")
    *   [Toy example of a ReAct agent's inner working](https://huggingface.co/blog/open-source-llms-as-agents#toy-example-of-a-react-agents-inner-working "Toy example of a ReAct agent&#39;s inner working")

    *   [Challenges of agent systems](https://huggingface.co/blog/open-source-llms-as-agents#challenges-of-agent-systems "Challenges of agent systems")

*   [Running agents with LangChain](https://huggingface.co/blog/open-source-llms-as-agents#running-agents-with-langchain "Running agents with LangChain")

*   [Agents Showdown: how do open-source LLMs perform as general purpose reasoning agents?](https://huggingface.co/blog/open-source-llms-as-agents#agents-showdown-how-do-open-source-llms-perform-as-general-purpose-reasoning-agents "Agents Showdown: how do open-source LLMs perform as general purpose reasoning agents?")
    *   [Evaluation](https://huggingface.co/blog/open-source-llms-as-agents#evaluation "Evaluation")

    *   [Models](https://huggingface.co/blog/open-source-llms-as-agents#models "Models")

    *   [Results](https://huggingface.co/blog/open-source-llms-as-agents#results "Results")

[](https://huggingface.co/blog/open-source-llms-as-agents#tldr) TL;DR
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
> We've released the simplest agentic library out there: [smolagents](https://github.com/huggingface/smolagents)! Go checkout the `smolagents` introduction blog [here](https://huggingface.co/blog/smolagents).

[](https://huggingface.co/blog/open-source-llms-as-agents#introduction) Introduction
------------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/open-source-llms-as-agents#table-of-contents) Table of Contents
----------------------------------------------------------------------------------------------

*   [What are agents?](https://huggingface.co/blog/open-source-llms-as-agents#what-are-agents)
    *   [Toy example of a ReAct agent's inner working](https://huggingface.co/blog/open-source-llms-as-agents#toy-example-of-a-react-agents-inner-working)
    *   [Challenges of agent systems](https://huggingface.co/blog/open-source-llms-as-agents#challenges-of-agent-systems)

*   [Running agents with LangChain](https://huggingface.co/blog/open-source-llms-as-agents#running-agents-with-langchain)
*   [Agents Showdown: how do different LLMs perform as general purpose reasoning agents?](https://huggingface.co/blog/open-source-llms-as-agents#agents-showdown-how-do-open-source-llms-perform-as-general-purpose-reasoning-agents)
    *   [Evaluation](https://huggingface.co/blog/open-source-llms-as-agents#evaluation)
    *   [Results](https://huggingface.co/blog/open-source-llms-as-agents#results)

[](https://huggingface.co/blog/open-source-llms-as-agents#what-are-agents) What are agents?
-------------------------------------------------------------------------------------------
...
![Image 4: drawing](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open-source-llms-as-agents/ReAct.png)

### [](https://huggingface.co/blog/open-source-llms-as-agents#toy-example-of-a-react-agents-inner-working) Toy example of a ReAct agent's inner working
...
Since this output does not contain the string `‘Final Answer:’`, it is calling a tool: so we parse this output and get the tool call parameters: call tool `convert_time` with arguments `{"time": "1:23:45"}`. Running this tool call returns `{'seconds': '5025'}`.
...
### [](https://huggingface.co/blog/open-source-llms-as-agents#challenges-of-agent-systems) Challenges of agent systems
...
[](https://huggingface.co/blog/open-source-llms-as-agents#running-agents-with-langchain) Running agents with LangChain
----------------------------------------------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/open-source-llms-as-agents#agents-showdown-how-do-open-source-llms-perform-as-general-purpose-reasoning-agents) Agents Showdown: how do open-source LLMs perform as general purpose reasoning agents?
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

You can find the code for this benchmark [here](https://github.com/aymeric-roucher/benchmark_agents/).

### [](https://huggingface.co/blog/open-source-llms-as-agents#evaluation) Evaluation

We want to measure how open-source LLMs perform as general purpose reasoning agents. Thus we select questions requiring using logic and the use of basic tools: a calculator and access to internet search. The [final dataset](https://huggingface.co/datasets/m-ric/agents_small_benchmark) is a combination of samples from 3 other datasets:
...
### [](https://huggingface.co/blog/open-source-llms-as-agents#models) Models
...
These models are evaluated in LangChain's [ReAct implementation](https://github.com/langchain-ai/langchain/tree/021b0484a8d9e8cf0c84bc164fb904202b9e4736/libs/langchain/langchain/agents/react) This means we prompt them to output their function calls in this format:
...
For comparison, we have also evaluated GPT-3.5 and GPT-4 on the same examples using LangChain's [OpenAI-specific agent](https://github.com/langchain-ai/langchain/tree/021b0484a8d9e8cf0c84bc164fb904202b9e4736/libs/langchain/langchain/agents/openai_functions_agent). Since this uses their own function-calling template, on which they were fine-tuned, this means the OpenAI models should be at their top performance.

### [](https://huggingface.co/blog/open-source-llms-as-agents#results) Results
...
![Image 5: benchmark of agents performance](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open-source-llms-as-agents/benchmark_agents.png)
