...
URL Source: https://www.benedict.dev/closing-the-software-loop

Published Time: 2026-01-25

Markdown Content:
I remember once hearing Andrej Karpathy say that the north star for Tesla systems was that the[autopilot team could go on vacation and the cars would not only survive but get better at driving](https://seekingalpha.com/article/4305856-tesla-operation-vacation). Recently at Meridian, we have been wondering what it would look like if we could apply this principle to a normal chat-based software app.
...
3.   Teams such as[Listen Labs](https://listenlabs.ai/)conduct user interviews with agents on behalf of teams. It will not be long before this type of process leads to product roadmap insights.
