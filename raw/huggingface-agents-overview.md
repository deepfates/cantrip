---
title: "HuggingFace Blog - Agents Overview"
...
URL Source: https://huggingface.co/blog/agents
...
[![Image 2: Lysandre's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/5e3aec01f55e2b62848a5217/PMKS0NNB4MJQlTSFzh918.jpeg)](https://huggingface.co/lysandre)
...
*   [TL;DR](https://huggingface.co/blog/agents#tldr "TL;DR")

*   [Table of Contents](https://huggingface.co/blog/agents#table-of-contents "Table of Contents")

*   [What is an agent?](https://huggingface.co/blog/agents#what-is-an-agent "What is an agent?")

*   [The Transformers Agents approach](https://huggingface.co/blog/agents#the-transformers-agents-approach "The Transformers Agents approach")
    *   [Main elements](https://huggingface.co/blog/agents#main-elements "Main elements")

*   [Example use cases](https://huggingface.co/blog/agents#example-use-cases "Example use cases")
    *   [Self-correcting Retrieval-Augmented-Generation](https://huggingface.co/blog/agents#self-correcting-retrieval-augmented-generation "Self-correcting Retrieval-Augmented-Generation")

    *   [Using a simple multi-agent setup 🤝for efficient web browsing](https://huggingface.co/blog/agents#using-a-simple-multi-agent-setup-%F0%9F%A4%9D-for-efficient-web-browsing "Using a simple multi-agent setup 🤝 for efficient web browsing")

*   [Testing our agents](https://huggingface.co/blog/agents#testing-our-agents "Testing our agents")
    *   [Benchmarking LLM engines](https://huggingface.co/blog/agents#benchmarking-llm-engines "Benchmarking LLM engines")

    *   [Climbing up the GAIA Leaderboard with a multi-modal agent](https://huggingface.co/blog/agents#climbing-up-the-gaia-leaderboard-with-a-multi-modal-agent "Climbing up the GAIA Leaderboard with a multi-modal agent")

*   [Conclusion](https://huggingface.co/blog/agents#conclusion "Conclusion")

[](https://huggingface.co/blog/agents#tldr) TL;DR
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/agents#table-of-contents) Table of Contents
--------------------------------------------------------------------------

*   [What is an agent?](https://huggingface.co/blog/agents#what-is-an-agent)
*   [The Transformers Agents approach](https://huggingface.co/blog/agents#the-transformers-agents-approach)
    *   [Main elements](https://huggingface.co/blog/agents#main-elements)

*   [Example use-cases](https://huggingface.co/blog/agents#example-use-cases)
    *   [Self-correcting Retrieval-Augmented-Generation](https://huggingface.co/blog/agents#self-correcting-retrieval-augmented-generation)
    *   [Using a simple multi-agent setup 🤝for efficient web browsing](https://huggingface.co/blog/agents#using-a-simple-multi-agent-setup-for-efficient-web-browsing)

*   [Testing our agents](https://huggingface.co/blog/agents#testing-our-agents)
    *   [Benchmarking LLM engines](https://huggingface.co/blog/agents#benchmarking-llm-engines)
    *   [Climbing up the GAIA Leaderboard with a multi-modal agent](https://huggingface.co/blog/agents#climbing-up-the-gaia-leaderboard-with-a-multi-modal-agent)

*   [Conclusion](https://huggingface.co/blog/agents#conclusion)

[](https://huggingface.co/blog/agents#what-is-an-agent) What is an agent?
-------------------------------------------------------------------------
...
[](https://huggingface.co/blog/agents#the-transformers-agents-approach) The Transformers Agents approach
--------------------------------------------------------------------------------------------------------
...
### [](https://huggingface.co/blog/agents#main-elements) Main elements
...
![Image 4: graph of agent workflows](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/agents/agent_single_multistep.png)
...
[](https://huggingface.co/blog/agents#example-use-cases) Example use cases
--------------------------------------------------------------------------
...
### [](https://huggingface.co/blog/agents#self-correcting-retrieval-augmented-generation) Self-correcting Retrieval-Augmented-Generation
...
*   _`tools`_: a list of tools that the agent will be able to call.
*   _`llm\_engine`_: the LLM that powers the agent.
...
### [](https://huggingface.co/blog/agents#using-a-simple-multi-agent-setup-%F0%9F%A4%9D-for-efficient-web-browsing) Using a simple multi-agent setup 🤝for efficient web browsing
...
> _Use density measures from the chemistry materials licensed by Marisa Alviar-Agnew & Henry Agnew under the CK-12 license in LibreText's Introductory Chemistry materials as compiled 08/21/2023._ _I have a gallon of honey and a gallon of mayonnaise at 25C. I remove one cup of honey at a time from the gallon of honey. How many times will I need to remove a cup to have the honey weigh less than the mayonaise? Assume the containers themselves weigh the same._
...
[](https://huggingface.co/blog/agents#testing-our-agents) Testing our agents
----------------------------------------------------------------------------
...
### [](https://huggingface.co/blog/agents#benchmarking-llm-engines) Benchmarking LLM engines
...
![Image 5: benchmark of agent performances](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/agents/aggregate_score.png)
...
### [](https://huggingface.co/blog/agents#climbing-up-the-gaia-leaderboard-with-a-multi-modal-agent) Climbing up the GAIA Leaderboard with a multi-modal agent
...
![Image 6: GAIA leaderboard](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/agents/leaderboard.png)

⇒ Our agent ranks 4th: it beats many GPT-4-based agents, and is now the reigning contender for the Open-Source category!

[](https://huggingface.co/blog/agents#conclusion) Conclusion
------------------------------------------------------------
