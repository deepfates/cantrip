...
import { Agent as CantripAgent } from "../agent/service";
import { TextEvent, FinalResponseEvent } from "../agent/events";
 ...
 * @example
 * ```typescript
 * import { Agent, ChatAnthropic, unsafeFsTools, done } from "cantrip";
