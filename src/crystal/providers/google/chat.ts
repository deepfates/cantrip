...
export class ChatGoogle implements BaseChatModel {
  ...
  private buildCacheKey(system_instruction: string | undefined, tools?: GateDefinition[] | null): string {
  ...
  private getToolChoice(tool_choice: ToolChoice | null | undefined, tools?: GateDefinition[] | null): any {
